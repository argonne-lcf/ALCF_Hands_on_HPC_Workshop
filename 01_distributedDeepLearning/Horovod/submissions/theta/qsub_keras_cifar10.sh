...
#COBALT -A SDL_Workshop -O results/theta/$jobid.tensorflow2_keras_cifar10
...
aprun -n $(($COBALT_JOBSIZE*$PROC_PER_NODE)) -N $PROC_PER_NODE \
    ...
    -e KMP_BLOCKTIME=0 \
    python tensorflow2_keras_cifar10.py --num_threads=32 --device cpu --epochs 128 >& results/theta/tensorflow2_keras_cifar10.out 
