...
def parse_args():
    ...
    parser.add_argument("--trace-dir", type=str, default="/lus/flare/projects/datasets/softwares/training/atpesc_2025_aiml_profiling/for_atpesc/traces/pytorch_2p8/")
